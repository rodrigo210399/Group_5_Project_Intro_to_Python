...
# How to use the code.
## Run the `dataframe_updating.py`file as a python file running the next command in the terminal `python dataframe_updating.py`. This will start scrapping the data from [Yahoo Finance Top Gainers](https://finance.yahoo.com/gainers.) and updating the database.
